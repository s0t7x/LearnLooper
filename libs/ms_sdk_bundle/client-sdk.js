(function (root, factory) {
    ...
    var AppClient = function () {
        _.bindAll(this, "_initializationFilter", "init", "isInitialized",
            ...
            "_isAutoLoginActivated", "_updateAutoLoginData", "_clearAutoLoginData");
        ...
        var APPCLIENT_SECURE_FUNCTIONS_LIST = [
            "retrySync", "resetFailedSync", "revertLocalChanges", "logout",
            "invoke", "post", "get", "getDeferredActions", "saveDeferredActions",
            "clearCache"
        ];
    ...
    AppClient.prototype._secureProjectFilter = function(destFunc){
        if (this.settings.isProjectSecured && !this._isUserLoggedInSync()) {
            ...
            .then(function () {
                ...
                promise = promise.then(function () {
                    if(this._isAutoLoginActivated()){
                        ...
                        return Q.Promise(function (resolve, reject) {
                            localforage.getItem(this._autoLoginStorageKey, function (err, value) {
                                if (err) {
                                    reject(err);
                                } else {
                                    resolve(value);
                         ...
                         .then(function (autoLoginUser) {
                             if(!_.isUndefined(autoLoginUser) && !_.isNull(autoLoginUser)){
                                 ...
                                 return this.login(autoLoginUser.userName, autoLoginUser.password).then(function () {
                                     if(this.isOnline()){
    ...
    AppClient.prototype._updateAutoLoginData = function () {
        if(this._isAutoLoginActivated() && !_.isUndefined(this._currentUser) && !_.isNull(this._currentUser)){
            //updating autologin data
            var autoLoginUser = _.clone(_.omit(this._currentUser,"secret"));
            autoLoginUser.password = CryptoJS.AES.encrypt(autoLoginUser.password, this._autoLogin).toString();
            return Q.fcall(function(){
                localforage.setItem(this._autoLoginStorageKey, autoLoginUser)
            }.bind(this));
        }else{
            return this._clearAutoLoginData();
        }
...
// Entity DAO
    ...
    var EntityDAO = function (sdkInstance, modelName, modelMetadata, isCustomModel) {
        _.bindAll(this, "init", "create", "get", "update", "delete", "find", "clearCache", "validate", "_deferAction", "_performDeferredAction", "_revertDeferredActionChanges");
        var ENTITYDAO_SECURE_FUNCTIONS_LIST = [
        ...
        for(var i = 0; i< ENTITYDAO_SECURE_FUNCTIONS_LIST.length; i++){
            var functionName = ENTITYDAO_SECURE_FUNCTIONS_LIST[i];
